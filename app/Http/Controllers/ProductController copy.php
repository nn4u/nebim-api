            ...
            try {
                ...
                if (!$product) {
                    ...
                    foreach ($productGroup as $productRecord) {
                        ...
                        if (!in_array($data['ColorDescription'], $uniqueColors)) {
                            $uniqueColors[] = $data['ColorDescription'];
                        }
                ...
                foreach ($productGroup as $productRecord) {
                    ...
                    $combination = "{$data['ColorDescription']}|{$data['ItemDim1Code']}";
